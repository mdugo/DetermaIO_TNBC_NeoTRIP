...
round(table(df$Clinical_stage, useNA="ifany")/nrow(df)*100,1)
round(table(df2$Clinical_stage, useNA="ifany")/nrow(df2)*100,1)
chisq.test(cbind(table(df$Clinical_stage), table(df2$Clinical_stage)))

round(table(df$PDL1_IHC, useNA="ifany")/nrow(df)*100,1)
round(table(df2$PDL1_IHC, useNA="ifany")/nrow(df2)*100,1)
chisq.test(cbind(table(df$PDL1_IHC), table(df2$PDL1_IHC)))

round(table(df$sTILs_IHC, useNA="ifany")/nrow(df)*100,1)
round(table(df2$sTILs_IHC, useNA="ifany")/nrow(df2)*100,1)
chisq.test(cbind(table(df$sTILs_IHC), table(df2$sTILs_IHC)))

round(table(df$Arm, useNA="ifany")/nrow(df)*100,1)
round(table(df2$Arm, useNA="ifany")/nrow(df2)*100,1)
chisq.test(cbind(table(df$Arm), table(df2$Arm)))

round(table(df$pCR, useNA="ifany")/nrow(df)*100,1)
round(table(df2$pCR, useNA="ifany")/nrow(df2)*100,1)
chisq.test(cbind(table(df$pCR), table(df2$pCR)))

round(table(df$IO_cat_NGS, useNA="ifany")/nrow(df)*100,1)
round(table(df2$IO_cat_NGS, useNA="ifany")/nrow(df2)*100,1)
chisq.test(cbind(table(df$IO_cat_NGS), table(df2$IO_cat_NGS)))

round(table(df$IO_cat_qPCR, useNA="ifany")/nrow(df)*100,1)
round(table(df2$IO_cat_qPCR, useNA="ifany")/nrow(df2)*100,1)
chisq.test(cbind(table(df$IO_cat_qPCR), table(df2$IO_cat_qPCR)))

round(table(df$TNBCtypes, useNA="ifany")/nrow(df)*100,1)
round(table(df2$TNBCtypes, useNA="ifany")/nrow(df2)*100,1)
chisq.test(cbind(table(df$TNBCtypes), table(df2$TNBCtypes)))
